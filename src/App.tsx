  ...
  return (
    <div className="min-h-screen bg-[#F4F5F8] text-[#1a1a1a] font-sans selection:bg-[#003B5C] selection:text-white flex flex-col items-center overflow-x-hidden">
      ...
      <a 
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 z-[999] bg-[#25D366] text-white p-4 rounded-full shadow-[0_10px_30px_-5px_rgba(37,211,102,0.6)] hover:scale-110 hover:shadow-[0_15px_40px_-5px_rgba(37,211,102,0.8)] transition-all flex items-center justify-center group"
      >
